...
from blue.mpesa_credentials import MpesaAccessToken, LipanaMpesaPpassword
...
class SafMethods:
    ...
    def send_push(self, args, phone_number):
        try:
            ...
            request_body = {
                ...
                "CallBackURL": "https://api-sacco.tritel.co.ke/api/v1/c2b/callback",
    ...
    def register_url(self):
        ...
        args = {
            ...
            "ConfirmationURL": "https://api-sacco.tritel.co.ke/api/v1/c2b/callback",
            "ValidationURL": "https://api-sacco.tritel.co.ke/c2b/v1/api/validationResponse"
        }
